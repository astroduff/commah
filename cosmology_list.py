"""Some pre-defined sets of cosmological parameters (e.g. from WMAP) copied and expanded from the cosmolopy list that's no longer updated.
"""
...
def DRAGONS(flat=False, extras=True):
    """DRAGONS cosmology assumes WMAP7 + BAO + H_0 mean from Komatsu et al. (2011) ApJS 192 18K
    (arxiv:1001.4538v1)
...
def WMAP1_2dF_mean(flat=False, extras=True):
    """WMAP1 with 2dF and ACBAR results from Spergel et al. (2003) ApJS 148 175S
...
def Planck_2013(flat=False, extras=True):
    """Planck 2013 XVI: Scalar Perturbations only (Maximum Likelihood) from Ade et al. (2013) A&A 571 16
    (arxiv:1303.5076)
